  ...
  return (
    <TabsContent value="introduction">
      ...
      <P className="mt-8">
        ...
        corporis, asperiores distinctio rem reiciendis ullam incidunt excepturi perferendis minus provident perspiciatis
        accusantium iusto cum? Odio officiis, debitis quod illum maiores vitae sequi odit unde aspernatur modi soluta
        ab. Impedit dignissimos temporibus officiis eligendi. Vero error porro alias, obcaecati qui nihil nesciunt in
        beatae! Tenetur.
      </P>
    </TabsContent>
  );
